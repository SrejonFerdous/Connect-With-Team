...
<?php  
        ...
        $name = $email = $dob = $gender = $pass = $phone = "";
        ...
        if( $_SERVER["REQUEST_METHOD"] == "POST" ){
            ...
            if( !empty($name) && !empty($email) && !empty($pass) ){
                ...
                if( mysqli_num_rows($r) > 0 ){
                    ...
                    $sql = "INSERT INTO admin( name ,phone, email , password , dob, gender ) VALUES( '$name' ,'$phone', '$email' , '$pass' , '$dob' , '$gender' )  ";
                    $result = mysqli_query($conn , $sql);
                    if($result){
                        $name = $phone = $email = $dob = $gender = $pass = "";
                        echo "<script>
